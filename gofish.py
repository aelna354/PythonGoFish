...
class Game():
	...
	def playerDraw(self, show=True):
		...
		if show: #The initial 7 cards drawn are skipped.
	...
	def playerTurn(self):
		...
		f"You have completed {len(self.playerSuites)} Suites and are holding {len(self.playerHand)} cards.\n"+
		f"The computer has completed {len(self.computerSuites)} Suites and is holding {len(self.computerHand)} cards.\n"+
		...
		if self.turn:
			...
			input("It is now the computer's turn. Press enter to close this text and start it.")
	...
	def computerTurn(self):
		...
		print(
		f"It is now the computer's turn. There are currently {len(self.deck)} cards in the deck.\n"+
		f"You have completed {len(self.playerSuites)} Suites and are holding {len(self.playerHand)} cards.\n"+
		f"The computer has completed {len(self.computerSuites)} Suites and is holding {len(self.computerHand)} cards.\n"+
		f"You have the following cards in your hand:\n\n{self.printHand()}\n")

		input("Press enter for the opponent to start their turn.")
	...
	def game(self):
		...
		print("Tossing coin to determine who goes first...")
		if self.turn:
			print("You go first! Each player now draws 7 cards...")
		else:
			print("Computer goes first! Each player nows draw 7 cards...")
		...
		elif 7 == len(self.computerSuites):
			clear()
